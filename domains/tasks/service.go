...
type TaskService interface {
	...
	GetListTask(string, string, string, string, string) ([]Task, error)
...
func (svc *Service) GetListTask(sortTitle string, sortCreateAt string, sortStatus string, searchTitle string, searchDescription string) ([]Task, error) {
	return svc.Repository.GetListTask(sortTitle, sortCreateAt, sortStatus, searchTitle, searchDescription)
}
